...
const Onboarding2 = () => {
    return (
        <div className="flex flex-col justify-center items-center h-full bg-cover bg-center text-white" style={{ backgroundImage: 'url(https://res.cloudinary.com/djrdw0sqz/image/upload/v1721766497/image_8_lyaeks.png)' }}>
